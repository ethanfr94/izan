...
public class Ejercicio3 {
    ...
    public static void main(String[] args) {
        ...
        do {System.out.printf("\n\nBASE DE DATOS DE PAISES\n%s"
            ...
            switch (n) {
                case 1-> esp.insertar();
                case 2-> System.out.println(esp.topHabitantes().toString());
                case 3-> {t = new Scanner(System.in);
                    ...
                    } else {System.out.println("NO se ha encontrado la ciudad que estabas buscando.");}}
                case 4-> {System.out.printf("La población media de las ciudades de %s es de %d",
                        esp.getNombre(), esp.poblacionMedia());}
                case 5-> {System.out.println(esp.toString());}
                case 6-> {System.out.println("Hasta Luego");}
                default-> {System.out.println("Has introducido una opcion incorrecta");}}
        } while (n!=6);}
}
